  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          content
          <input value={content.value} onChange={content.onChange} type={content.type} />
        </div>
        <div>
          author
          <input value={author.value} onChange={author.onChange} type={author.type} />
        </div>
        <div>
          url for more info
...
const App = () => {
  ...
  const Notification = (name) => {
    setNotification(`A new anecodte ${name} created`)
    setTimeout(() => {
      setNotification('')
    }, 10000)
  }
